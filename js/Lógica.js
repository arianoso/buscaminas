/* JS (Lógica) */
    let sonido_ganador = new Audio("sonidos/sonido_ganador.ogg")
    let sonido_win = new Audio("sonidos/sonido_win.ogg")
    let sonido_perdedor = new Audio("sonidos/sonido_perdedor.ogg")
    let sonido_gameover = new Audio("sonidos/sonido_gameover.ogg")
    let sonido_descubrir = new Audio("sonidos/sonido_descubrir.ogg")
    let sonido_juegonuevo = new Audio("sonidos/sonido_nuevojuego.ogg")
    ...
    async function ajustes() {
      const {
        ...
        html: `
                ...
                <br>
                `,
         backdrop: `rgb(146, 107, 3, 0.4) url("/img/Arian.png") left top no-repeat`,
